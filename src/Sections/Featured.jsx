  ...
  return (
    ...
    >
      <div className="grid  grid-rows-[auto_auto] mb-4 place-items-center gap-2 w-full min-h-[20rem]">
        <div className="grid grid-rows-[200px_auto] md:grid-rows-[150px_auto] lg:grid-rows-[100px_auto]">
          <div className="w-full flex text-center justify-center items-end pb-6 px-4 md:pb-2 md:px-12 h-full md:pt-0 lg:pb-0 ">
